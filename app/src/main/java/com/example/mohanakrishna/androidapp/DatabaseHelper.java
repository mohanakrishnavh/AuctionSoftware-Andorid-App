...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "buyer.db";
    private static final String TABLE_NAME="buyertable";
    ...
    private static final String TABLE_CREATE="create table buyertable (id integer primary key not null," +
    ...
    public void insertBuyer(Contact c)
    {
        try{
    ...
    {
        db.execSQL("create table buyertable (id integer primary key not null," +
                "name text not null,email text not null,phone text not null,password text not null);");
    ...
    {
        db.execSQL("drop table if exists buyertable");
        onCreate(db);
